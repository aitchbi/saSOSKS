...
% 
% Note: Took this chunk of code out of spgg_kernel_1.m & spgg_kernel_2.m. 
%
%
%
% Hamid Behjat 
...
%Took below code from spgg_kernel_2.m; should be identical to that above. 
% if strcmp(warping,'none')
%     
% elseif ~isempty(warpingBins) 
%     interp_x=warpingBins;
